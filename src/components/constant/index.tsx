...
import Ariston from "@images/New series sintered stone slabs/Ariston white.jpg"
import Blanco from "@images/New series sintered stone slabs/Blanco.jpg"
import Camel from "@images/New series sintered stone slabs/Camel.jpg"
import Cleveland from "@images/New series sintered stone slabs/Cleveland white.jpg"
import natural from "@images/New series sintered stone slabs/Gotland natural.jpg"
import Maserati from "@images/New series sintered stone slabs/Maserati Greay.jpg"
import Pure from "@images/New series sintered stone slabs/Pure White.jpg"
import black from "@images/New series sintered stone slabs/Pure black.jpg"
  ...
  tab1: {
    ...
    nestedTabs: {
      nestedTab1: {
        ...
        products: [{
          title: 'Richmond SPC Eco- Cappuccino',
          imageUrl: SPC2,
          size:"1220mm x 183mm x 5.5mm",

        },
        {
          title: 'Richmond SPC Eco- OAK',
          imageUrl: SPC8,
          size:"1220mm x 183mm x 5.5mm",
        ...
        {
          title: 'Richmond SPC Eco- MAHOGANY',
          imageUrl: SPC6,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- FOREST',
          imageUrl: SPC5,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- Premium Oak',
          imageUrl: SPC9,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- Espresso Noir',
          imageUrl: SPC4,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- Silver',
          imageUrl: SPC10,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- Cherry',
          imageUrl: SPC3,
          size:"1220mm x 183mm x 5.5mm"
        },
        {
          title: 'Richmond SPC Eco- American Walnut',
          imageUrl: SPC1,
          size:"1220mm x 183mm x 5.5mm"
        },],
      },
      nestedTab2: {
        ...
        products: [
          {
            title: 'Richmond SPC Prime- American Walnut',
            imageUrl: PRIME1,

            size:"1524mm x 228mm x 6.5mm"
          },
          {
            title: 'Richmond SPC Prime- Cappuccino',
            imageUrl: PRIME2,

            size:"1524mm x 228mm x 6.5mm"
          },
          {
            title: 'Richmond SPC Prime- OAK HISTORY',
            imageUrl: PRIME4,

            size:"1524mm x 228mm x 6.5mm"
          },
          {
            title: 'Richmond SPC Prime- Espresso Noir',
            imageUrl: PRIME3,
          ...
          {
            title: 'Richmond SPC Prime- Premium Oak',
            imageUrl: PRIME5,
      ...
      nestedTab3: {
        label: 'RICHMOND SPC HERRINGBONE',
        products: [
          {
      ...
      {
        title: 'Richmond SPC Herringbone - Premium Oak',
      ...
      {
        title: 'Richmond SPC Herringbone - MAHOGANY',
        imageUrl: HERRINGBONE3,
        link: 'product',
        size:"640mm x 128mm x 5.5mm"
      },
      {
        title: 'Richmond SPC Herringbone - FOREST',
        imageUrl: HERRINGBONE2,
        link: 'product',
        size:"640mm x 128mm x 5.5mm"
      },
      {
        title: 'Richmond SPC Herringbone -Silver',
