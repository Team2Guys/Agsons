...
const accordionData: AccordionItem[] = [
  {
    ...
    answer: 'Richmond Flooring (SPC & LVT), Sintrich (Sintered Stone), and Monster (Silicon and nail free Clue).'
  },
  {
    question: 'WHAT TYPES OF FLOORING DOES AGSONS OFFER?',
    answer: 'We offer a variety of flooring types including SPC, LVT, and Sintered Stone.'
  },
  {
    question: 'WHAT ARE THE BENEFITS OF SINTRICH STONE?',
    answer: 'Sintrich Stone offers durability, aesthetic appeal, and is eco-friendly.'
  }
];
  ...
  return (
    <div className="max-w-2xl mx-auto py-12">
      ...
      {accordionData.map((item, index) => (
        <div key={index} className="mb-4 border rounded-lg bg-gray-100">
          <button
